...
function FilteredProductList({ modelList, colorInfoList }) {
  ...
  return (
    <div className="mt-5 max-w-7xl mx-auto px-4">
      <h2 className="text-green-600 font-bold text-2xl">Filtered Products</h2>
  ...
  .reduce((total, item) => total + item.quantity, 0);
          ...
          return (
            <div key={model.Model} className="border p-4 rounded-lg shadow-lg w-[350px] relative">
      ...
      {isModalOpen && selectedModel && (() => {
        ...
        return (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center w-full items-center py-3">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-[37rem] w-full relative">
              <div className="mt-4">
                ...
                <div className="flex items-center mt-2">
                  ...
                  <div className=" w-[19rem] overflow-y-auto scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-400 max-h-[15rem]">
